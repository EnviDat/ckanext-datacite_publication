...
class DatacitePublicationController(toolkit.BaseController):
    ...
    def finish_publication_package(self, package_id):
        ...
        log.debug("controller: finish_publication_package: {0}".format(package_id))
    ...
    def update_publication_package(self, package_id):
        ...
        log.debug("controller: update_publication_package: {0}".format(package_id))
